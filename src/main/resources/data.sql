...
INSERT INTO packages (name, description, recipient, addresser, status) VALUES ('Package 1', 'pack1', 1, 2, 'SENT');
INSERT INTO packages (name, description, recipient, addresser, status) VALUES ('Package 2', 'pack2', 2, 3, 'DELIVERED');
INSERT INTO packages (name, description, recipient, addresser, status) VALUES ('Package 3', 'pack3', 3, 1, 'RECEIVED');
INSERT INTO packages (name, description, recipient, addresser, status) VALUES ('Package 4', 'pack4', 3, 2, 'COMING');
